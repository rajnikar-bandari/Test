...
if(isset($_POST['submit']))
{
  ...
  /*if($_POST['rd_tel']=='Yes') {  //Language details 
        $rd_tel = $_POST['rd_tel'];
  } else { $rd_tel = 'No'; }
  ...
  if($empupd) {
		...
		$empfam = mysqli_query($con,"INSERT INTO reg_familydet (e_code,relation,name,dob,age,aadhar_no,aadhar_img) VALUES('".$ecode."','".$erel."','".$relname."','".$reldob."','".$relage."','".$relaad."','".$ins_adar."')");

		if($erel2!='' and $relage2!='') {
			...
			$targetPath = $targetDir.$rand_value.'.'.$ext;
			move_uploaded_file($sourcePath,$targetPath);
				$empfam = mysqli_query($con,"INSERT INTO reg_familydet (e_code,relation,name,dob,age,aadhar_no,aadhar_img) VALUES('".$ecode."','".$erel2."','".$relname2."','".$reldob2."','".$relage2."','".$relaad2."','".$ins_adar2."')");
			}
		}

		if($erel3!='' and $relage3!='') {
			...
			$targetPath = $targetDir.$rand_value.'.'.$ext;
			move_uploaded_file($sourcePath,$targetPath);
			$empfam = mysqli_query($con,"INSERT INTO reg_familydet (e_code,relation,name,dob,age,aadhar_no,aadhar_img) VALUES('".$ecode."','".$erel3."','".$relname3."','".$reldob3."','".$relage3."','".$relaad3."','".$ins_adar3."')");
			}
		}

		if($erel4!='' and $relage4!='') {
			...
			$targetPath = $targetDir.$rand_value.'.'.$ext;
			move_uploaded_file($sourcePath,$targetPath);
			$empfam = mysqli_query($con,"INSERT INTO reg_familydet (e_code,relation,name,dob,age,aadhar_no,aadhar_img) VALUES('".$ecode."','".$erel4."','".$relname4."','".$reldob4."','".$relage4."','".$relaad4."','".$ins_adar4."')");
			}
		}

		if($erel5!='' and $relage5!='') {
			...
			$targetPath = $targetDir.$rand_value.'.'.$ext;
			move_uploaded_file($sourcePath,$targetPath);
			$empfam = mysqli_query($con,"INSERT INTO reg_familydet (e_code,relation,name,dob,age,aadhar_no,aadhar_img) VALUES('".$ecode."','".$erel5."','".$relname5."','".$reldob5."','".$relage5."','".$relaad5."','".$ins_adar5."')");
			}
		}

		if($erel6!='' and $relage6!='') {
			...
			$targetPath = $targetDir.$rand_value.'.'.$ext;
			move_uploaded_file($sourcePath,$targetPath);
			$empfam = mysqli_query($con,"INSERT INTO reg_familydet (e_code,relation,name,dob,age,aadhar_no,aadhar_img) VALUES('".$ecode."','".$erel6."','".$relname6."','".$reldob6."','".$relage6."','".$relaad6."','".$ins_adar6."')");
			}
		}

		$empupd = mysqli_query($con,"INSERT INTO reg_bankpfdet (e_code,ac_holder_name,bank_name,account_num,branch,acc_type,pp_no,issue_dt,exp_dt,pf_acc_no,uan_no,date_of_exit_prev,nominee_name,relation,nominee_dob) VALUES('".$ecode."','".$ahn."','".$bank_name."','".$ac_no."','".$brach_name."','".$ac_type."','".$pp_no."','".$pp_issuedt."','".$pp_expdt."','".$pf_no."','".$uan_no."','".$dt_exit."','".$nom_name."','".$relation."','".$nom_dob."')");
	   ...
	   $empaca4 = mysqli_query($con,"INSERT INTO reg_academicdet (e_code,qualification,year_of_passing,name_of_school,major_sub,div_perc) VALUES('".$ecode."','".$qual14."','".$yop14."','".$univ14."','".$ms14."','".$perc14."')");
		...
		/*$emplang = mysqli_query($con,"INSERT INTO reg_lang_prof (e_code,language,lang_read,lang_write,lang_speak) VALUES('".$ecode."','Telugu','".$rd_tel."','".$wr_tel."','".$sp_tel."')");
		$emplang2 = mysqli_query($con,"INSERT INTO reg_lang_prof (e_code,language,lang_read,lang_write,lang_speak) VALUES('".$ecode."','Hindi','".$rd_hin."','".$wr_hin."','".$sp_hin."')");
		$emplang3 = mysqli_query($con,"INSERT INTO reg_lang_prof (e_code,language,lang_read,lang_write,lang_speak) VALUES('".$ecode."','English','".$rd_eng."','".$wr_eng."','".$sp_eng."')");
		$emplang4 = mysqli_query($con,"INSERT INTO reg_lang_prof (e_code,language,lang_read,lang_write,lang_speak) VALUES('".$ecode."','Other','".$rd_oth."','".$wr_oth."','".$sp_oth."')");*/
	  ...
	  $ins_payslips='';
	  $ins_rel_letter='';
		if(!empty($_FILES['ssc']['tmp_name'])) {
		$sourcePath = $_FILES['ssc']['tmp_name'];
		$ext = strtolower(pathinfo($_FILES['ssc']['name'], PATHINFO_EXTENSION));
		$rand_value = rand(1,100000);
		$ins_ssc = $rand_value.'.'.$ext;
		$targetPath = $targetDir.$rand_value.'.'.$ext;
		move_uploaded_file($sourcePath,$targetPath);
		//mysqli_query($con,"UPDATE reg_authorization SET aadhar_img = '".$ins_ssc."' WHERE e_code = '".$ecode."'");
		}

		if(!empty($_FILES['inter']['tmp_name'])) {
		$sourcePath = $_FILES['inter']['tmp_name'];
		$ext = strtolower(pathinfo($_FILES['inter']['name'], PATHINFO_EXTENSION));
		$rand_value = rand(1,100000);
		$ins_inter = $rand_value.'.'.$ext;
		$targetPath = $targetDir.$rand_value.'.'.$ext;
		move_uploaded_file($sourcePath,$targetPath);
		}

		if(!empty($_FILES['degree']['tmp_name'])) {
		$sourcePath = $_FILES['degree']['tmp_name'];
		$ext = strtolower(pathinfo($_FILES['degree']['name'], PATHINFO_EXTENSION));
		$rand_value = rand(1,100000);
		$ins_degree = $rand_value.'.'.$ext;
		$targetPath = $targetDir.$rand_value.'.'.$ext;
		move_uploaded_file($sourcePath,$targetPath);
		}

		if(!empty($_FILES['pg']['tmp_name'])) {
		$sourcePath = $_FILES['pg']['tmp_name'];
		$ext = strtolower(pathinfo($_FILES['pg']['name'], PATHINFO_EXTENSION));
		$rand_value = rand(1,100000);
		$ins_pg = $rand_value.'.'.$ext;
		$targetPath = $targetDir.$rand_value.'.'.$ext;
		move_uploaded_file($sourcePath,$targetPath);
		}
		...
		$ext = strtolower(pathinfo($_FILES['pan']['name'], PATHINFO_EXTENSION));
		$rand_value = rand(1,100000);
		$ins_pan = $rand_value.'.'.$ext;
		$targetPath = $targetDir.$rand_value.'.'.$ext;
		move_uploaded_file($sourcePath,$targetPath);
		}

		if(!empty($_FILES['offer_letter']['tmp_name'])) {
		$sourcePath = $_FILES['offer_letter']['tmp_name'];
		$ext = strtolower(pathinfo($_FILES['offer_letter']['name'], PATHINFO_EXTENSION));
		$rand_value = rand(1,100000);
		$ins_offlet = $rand_value.'.'.$ext;
		$targetPath = $targetDir.$rand_value.'.'.$ext;
		move_uploaded_file($sourcePath,$targetPath);
		}

		if(!empty($_FILES['rel_letter']['tmp_name'])) {
		$sourcePath = $_FILES['rel_letter']['tmp_name'];
		$ext = strtolower(pathinfo($_FILES['rel_letter']['name'], PATHINFO_EXTENSION));
		$rand_value = rand(1,100000);
		$ins_rel_letter = $rand_value.'.'.$ext;
		$targetPath = $targetDir.$rand_value.'.'.$ext;
		move_uploaded_file($sourcePath,$targetPath);
		}

		if(!empty($_FILES['pay_slips']['tmp_name'])) {
		$sourcePath = $_FILES['pay_slips']['tmp_name'];
		$ext = strtolower(pathinfo($_FILES['pay_slips']['name'], PATHINFO_EXTENSION));
		$rand_value = rand(1,100000);
		$ins_payslips = $rand_value.'.'.$ext;
		$targetPath = $targetDir.$rand_value.'.'.$ext;
		move_uploaded_file($sourcePath,$targetPath);
		}

		if(!empty($_FILES['pp_images']['tmp_name'])) {
		$sourcePath = $_FILES['pp_images']['tmp_name'];
		$ext = strtolower(pathinfo($_FILES['pp_images']['name'], PATHINFO_EXTENSION));
		$rand_value = rand(1,100000);
		$ins_ppimg = $rand_value.'.'.$ext;
		$targetPath = $targetDir.$rand_value.'.'.$ext;
		move_uploaded_file($sourcePath,$targetPath);
		}

		$empempment = mysqli_query($con,"INSERT INTO reg_refference (e_code,ssc,inter,degree,post_gradution,pan_card,offer_letter,releaving_letter,payslips,pp_image) VALUES('".$ecode."','".$ins_ssc."','".$ins_inter."','".$ins_degree."','".$ins_pg."','".$ins_pan."','".$ins_offlet."','".$ins_rel_letter."','".$ins_payslips."','".$ins_ppimg."')");

      $countfiles = count($_FILES['other_cert']['name']);
      for($i=0;$i<$countfiles;$i++){
      $filename = $_FILES['other_cert']['name'][$i];
	  $targetPath = $targetDir.$filename;
      //move_uploaded_file($_FILES['other_cert']['tmp_name'][$i],'empdocs/'.$ecode.'/'.$filename);
      move_uploaded_file($_FILES['other_cert']['tmp_name'][$i],$targetPath);
		$empempment = mysqli_query($con,"INSERT INTO reg_other_certificates (e_code,file_name) VALUES('".$ecode."','".$filename."')");
      }*/
...
<li>
  <a href="#ppadpn" aria-controls="ppadpn" role="tab" data-toggle="tab" aria-expanded="false">Passport,Aadhar and Pan Details</a>
</li>
<li>
...
<!-- <li>
  <a href="#lang" aria-controls="lang" role="tab" data-toggle="tab" aria-expanded="false">Language Proficiency</a>
</li> -->
<li>
  <a href="#emp" aria-controls="emp" role="tab" data-toggle="tab" aria-expanded="false">Employment Details</a>
</li>
<li>
  <a href="#eca" aria-controls="eca" role="tab" data-toggle="tab" aria-expanded="false">	Extra Curriculars</a>
</li>
</ul>
...
<div style="align:center;"><font color="#330099"><?php if($msg) { echo $msg; } ?></font></div>
...
<div class="col-sm-4">
	<input type="text" name="act_dob" id="act_dob" class="form-control" autocomplete="off" />
</div>
</div>
<div class="formgap">&nbsp;</div>
...
<div class="col-sm-4">
	<input type="text" name="madate" id="madate" class="form-control"  autocomplete="off" readonly />
</div>
</div>
<div class="formgap">&nbsp;</div>
...
<label class="col-sm-2 control-label">Profile Pic<font color="#ff0000">*</font></label>
<div class="col-sm-4">
...
<div role="tabpanel" class="tab-pane" id="ppadpn">

<div class="col-sm-1"></div>
<div class="col-sm-5">
	<div class="tabhead1"><h3 class="">Passport,Aadhar and Pan Details</h3></div>
<div class="tabhead1" style="padding-top: 15px;"><h4>Passport Details</h4></div>
<div class="form-group">
...
<div class="col-sm-4">
	<input type="text" name="pp_issuedt" id="pp_issuedt" class="form-control" autocomplete="off" />
</div>
</div>
<div class="formgap">&nbsp;</div>
...
<div class="col-sm-4">
	<input type="text" name="pp_expdt" id="pp_expdt" class="form-control" autocomplete="off" />
</div>

<!-- <label class="col-sm-2 control-label">Issue Date<font color="#ff0000">*</font></label>
<div class="col-sm-4">
	<input type="text" name="pp_issuedt" id="pp_issuedt" class="form-control" />
</div> -->
</div>
<div class="formgap">&nbsp;</div>

<div class="tabhead1" style="padding-top: 15px;"><h4>Aadhar/PAN Details</h4></div>
<div class="form-group">
<label class="col-sm-2 control-label">Aadhar No<font color="#ff0000">*</font></label>
<div class="col-sm-4">
	<input type="text" name="emp_aadhar_no" id="emp_aadhar_no" placeholder="Emergency cont person address" class="form-control" title="Please enter mobile no" />
</div>

<label class="col-sm-2 control-label">PAN No<font color="#ff0000">*</font></label>
<div class="col-sm-4">
	<input type="text" name="emp_pan_no" id="emp_pan_no" placeholder="Emergency cont no" class="form-control" title="Please enter a email" />
</div>
</div>
<div class="formgap">&nbsp;</div>
<div class="form-group">
...
<div class="col-sm-4">
	<input type="file" name="emp_aadhar_img" id="emp_aadhar_img" class="form-control" />
</div>

<label class="col-sm-2 control-label">PAN Image<font color="#ff0000">*</font></label>
<div class="col-sm-4">
	<input type="file" name="emp_pan_img" id="emp_pan_img" class="form-control" />
</div>
</div>
<div class="formgap">&nbsp;</div>
...
<!-- Aadhar and passport details end -->
...
<div class="col-sm-5">
	...
	<div class="form-group">
	<label class="col-sm-2 control-label">HNo<font color="#ff0000">*</font></label>
<div class="col-sm-10">
...
<div class="col-sm-2">
<b>Relation</b><font color="#ff0000">*</font><br>
	<select name="erel" id="erel" class="form-control" style="height:30px" >
		...
		<option value="spouse">Spouse</option>
		<option value="ch1">Child1</option>
		<option value="ch2">Child2</option>
		<option value="ch3">Child3</option>
		<option value="ch4">Child4</option>
		</select>
</div>


<div class="col-sm-2">
<b>Name</b><font color="#ff0000">*</font><br>
...
<b>Date of Birth</b><font color="#ff0000">*</font><br>
	<input type="text" name="reldob" id="reldob" class="form-control" autocomplete="off" />
</div>
...
<div class="col-sm-2">
<b>Aadhar no</b><font color="#ff0000">*</font><br>
	<input type="text" name="relaad" id="relaad" class="form-control" />
</div>


<div class="col-sm-2">
<b>Aadhar Img</b><font color="#ff0000">*</font><br>
	<input type="file" name="reladimg" id="reladimg" class="form-control" />
</div>
...
<div class="col-sm-2">
	<input type="text" name="reldob2" id="reldob2" class="form-control" autocomplete="off" />
</div>
...
<div class="col-sm-2">
	<input type="file" name="reladimg2" id="reladimg2" class="form-control" />
</div>
...
<div class="col-sm-2">
	<input type="text" name="reldob3" id="reldob3" class="form-control" autocomplete="off" />
</div>
...
<div class="col-sm-2">
	<input type="file" name="reladimg3" id="reladimg3" class="form-control" />
</div>
...
<div class="col-sm-2">
	<input type="text" name="reldob4" id="reldob4" class="form-control" autocomplete="off" />
</div>
...
<div class="col-sm-2">
	<input type="file" name="reladimg4" id="reladimg4" class="form-control" />
</div>
...
<div class="col-sm-2">
	<input type="text" name="reldob5" id="reldob5" class="form-control" autocomplete="off" />
</div>
...
<div class="col-sm-2">
	<input type="file" name="reladimg5" id="reladimg5" class="form-control" />
</div>
...
<div class="col-sm-2">
	<input type="text" name="reldob6" id="reldob6" class="form-control" autocomplete="off" />
</div>
...
<div class="col-sm-2">
	<input type="file" name="reladimg6" id="reladimg6" class="form-control" />
</div>
...
<div class="col-sm-2">
	<input type="text" name="reldob7" id="reldob7" class="form-control" autocomplete="off" />
</div>
...
<div class="col-sm-2">
	<input type="file" name="reladimg7" id="reladimg7" class="form-control" />
</div>
...
<b>Date of Exit(Previous Employer)</b>
	<input type="text" name="dt_exit" id="dt_exit" class="form-control" />
</div>
</div>
<div class="formgap">&nbsp;</div>
...
<b>DOB of Nominee</b><font color="#ff0000">*</font>
	<input type="text" name="nom_dob" id="nom_dob" class="form-control" autocomplete="off" />
</div>
</div>
<div class="formgap">&nbsp;</div>
...
<div align="center" style="margin-top:15px"><a class="btn btn-primary back">Go Back</a>&nbsp;<a class="btn btn-primary continue">Continue</a> <!-- <button type="button" id="previewBtn" data-toggle="modal" data-target="#confirm-submit" class="mb-xs mt-xs mr-xs btn btn-primary">Preview</button> --><!-- <input type="submit" name="submit" class="mb-xs mt-xs mr-xs btn btn-primary" value="Submit"> --></div>
</div>
...
<div class="col-sm-6">
	<input type="text" name="appl_date" id="appl_date" class="form-control" />
</div>
</div>
<div class="formgap">&nbsp;</div>
...
$(document).ready(function(){
  $("form").submit(function(){
	...
	if(dob == '' || act_dob == '' || bgroup  == '' || high_edu  == '' || contno  == '' || nationality  == '' || emer_name  == '' || emer_rel  == '' || emer_addr  == '' || emer_cont  == '' || profile_pic = '')
	{
	...
	if(emp_aadhar_no  == '' || emp_pan_no  == '' || emp_aadhar_img  == '' || emp_pan_img  == '')
	  {
		alert('Please fill all the required fields in pf and aadhar/pan details');
	    return false;
	  }
	if(hno == '' || city == '' || state == '' || zipcode == '' || perm_hno == '' || perm_city == '' || perm_state == '' || perm_zipcode == '' || perm_country == '')
	  ...
	  if(erel == '' || relname == '' || reldob == '' || relage == '' || relaad == '' || reladimg == '')
	  {
	  alert('Please fill all the required fields in family details');
	  return false;
	  }
